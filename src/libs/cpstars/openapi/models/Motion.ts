...
export function MotionFromJSONTyped(json: any, ignoreDiscriminator: boolean): Motion {
  ...
  return {
    ...
    properMotionRaError: !exists(json, 'properMotionRaError')
      ? undefined
      : json['properMotionRaError'],
    properMotionDec: !exists(json, 'properMotionDec') ? undefined : json['properMotionDec'],
    properMotionDecError: !exists(json, 'properMotionDecError')
      ? undefined
      : json['properMotionDecError'],

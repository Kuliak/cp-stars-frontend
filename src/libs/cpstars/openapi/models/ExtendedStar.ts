...
import { ExternalDetailsFromJSON, ExternalDetailsToJSON } from './ExternalDetails';
...
export function ExtendedStarFromJSONTyped(json: any, ignoreDiscriminator: boolean): ExtendedStar {
  ...
  return {
    ...
    externalDetails: !exists(json, 'externalDetails')
      ? undefined
      : ExternalDetailsFromJSON(json['externalDetails']),
  };
}

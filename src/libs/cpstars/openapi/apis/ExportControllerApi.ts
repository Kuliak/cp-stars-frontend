...
import type { ExportCsvForm } from '../models';
import { ExportCsvFormToJSON } from '../models';
...
export class ExportControllerApi extends runtime.BaseAPI {
   ...
   */
  async downloadStarsCSVRaw(
    requestParameters: DownloadStarsCSVRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Array<string>>> {
    if (requestParameters.ExportCsvForm === null || requestParameters.ExportCsvForm === undefined) {
      throw new runtime.RequiredError(
        'ExportCsvForm',
        'Required parameter requestParameters.ExportCsvForm was null or undefined when calling downloadStarsCSV.'
      );
    }
   ...
   */
  async getExtendedStarTxtRaw(
    requestParameters: GetExtendedStarTxtRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<string>> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
      throw new runtime.RequiredError(
        'id',
        'Required parameter requestParameters.id was null or undefined when calling getExtendedStarTxt.'
      );
    }

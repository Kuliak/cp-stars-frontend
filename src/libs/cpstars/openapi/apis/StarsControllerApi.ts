...
export class StarsControllerApi extends runtime.BaseAPI {
   ...
   */
  async getBasicInfoStarsListRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Array<StarBasicInfo>>> {
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      jsonValue.map(StarBasicInfoFromJSON)
    );
  }
   ...
   * Get basic (general) information about all stars.
   */
  async getBasicInfoStarsList(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<Array<StarBasicInfo>> {
   ...
   */
  async getExtendedStarRaw(
    requestParameters: GetExtendedStarRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<ExtendedStar>> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
      throw new runtime.RequiredError(
        'id',
        'Required parameter requestParameters.id was null or undefined when calling getExtendedStar.'
      );
    }
    ...
    const response = await this.request(
      {
        path: `/stars/{id}/extended`.replace(
          `{${'id'}}`,
   ...
   * Get all information about specified star including data fetched from external sources.
   */
  async getExtendedStar(
    requestParameters: GetExtendedStarRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<ExtendedStar> {
   ...
   */
  async getStarRaw(
    requestParameters: GetStarRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Star>> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
      throw new runtime.RequiredError(
        'id',
        'Required parameter requestParameters.id was null or undefined when calling getStar.'
      );
    }
   ...
   */
  async getStarByRensonIdRaw(
    requestParameters: GetStarByRensonIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Star>> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
      throw new runtime.RequiredError(
        'id',
        'Required parameter requestParameters.id was null or undefined when calling getStarByRensonId.'
      );
    }
   ...
   */
  async getStarDatasourceAttributesRaw(
    requestParameters: GetStarDatasourceAttributesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Array<StarDatasourceAttribute>>> {
    if (requestParameters.starId === null || requestParameters.starId === undefined) {
      throw new runtime.RequiredError(
        'starId',
        'Required parameter requestParameters.starId was null or undefined when calling getStarDatasourceAttributes.'
      );
    }
    ...
    const response = await this.request(
      {
        path: `/stars/{starId}/stardatasourceattributes`.replace(
          `{${'starId'}}`,
          encodeURIComponent(String(requestParameters.starId))
        ),
        method: 'GET',
        headers: headerParameters,
        query: queryParameters,
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      jsonValue.map(StarDatasourceAttributeFromJSON)
    );
  }
   ...
   * Get all star attributes paired with corresponding datasource.
   */
  async getStarDatasourceAttributes(
    requestParameters: GetStarDatasourceAttributesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<Array<StarDatasourceAttribute>> {
   ...
   */
  async getStarIdentifiersRaw(
    requestParameters: GetStarIdentifiersRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Array<Identifier>>> {
    if (requestParameters.starId === null || requestParameters.starId === undefined) {
      throw new runtime.RequiredError(
        'starId',
        'Required parameter requestParameters.starId was null or undefined when calling getStarIdentifiers.'
      );
    }
    ...
    const response = await this.request(
      {
        path: `/stars/{starId}/identifiers`.replace(
          `{${'starId'}}`,
          encodeURIComponent(String(requestParameters.starId))
        ),
        method: 'GET',
   ...
   * Get all identifier corresponding to specified star.
   */
  async getStarIdentifiers(
    requestParameters: GetStarIdentifiersRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<Array<Identifier>> {
   ...
   */
  async getStarLightCurveMeasurementsRaw(
    requestParameters: GetStarLightCurveMeasurementsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Array<LightCurveMeasurement>>> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
      throw new runtime.RequiredError(
        'id',
        'Required parameter requestParameters.id was null or undefined when calling getStarLightCurveMeasurements.'
      );
    }
    ...
    const response = await this.request(
      {
        path: `/stars/light-curves/{id}`.replace(
          `{${'id'}}`,
          encodeURIComponent(String(requestParameters.id))
        ),
        method: 'GET',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      jsonValue.map(LightCurveMeasurementFromJSON)
    );
  }
   ...
   * Get light curve measurements of star (specified by CP-Stars identifier) from corresponding file.
   */
  async getStarLightCurveMeasurements(
    requestParameters: GetStarLightCurveMeasurementsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<Array<LightCurveMeasurement>> {
   ...
   */
  async getStarLightCurveMeasurementsByRensonRaw(
    requestParameters: GetStarLightCurveMeasurementsByRensonRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Array<LightCurveMeasurement>>> {
    if (requestParameters.rensonId === null || requestParameters.rensonId === undefined) {
      throw new runtime.RequiredError(
        'rensonId',
        'Required parameter requestParameters.rensonId was null or undefined when calling getStarLightCurveMeasurementsByRenson.'
      );
    }
    ...
    const response = await this.request(
      {
        path: `/stars/light-curves/{rensonId}/renson`.replace(
          `{${'rensonId'}}`,
          encodeURIComponent(String(requestParameters.rensonId))
        ),
        method: 'GET',
        headers: headerParameters,
        query: queryParameters,
   ...
   * Get light curve measurements of star (specified by Renson identifier) from corresponding file.
   */
  async getStarLightCurveMeasurementsByRenson(
    requestParameters: GetStarLightCurveMeasurementsByRensonRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<Array<LightCurveMeasurement>> {
    const response = await this.getStarLightCurveMeasurementsByRensonRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
   ...
   */
  async getStarMagnitudesRaw(
    requestParameters: GetStarMagnitudesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Array<Magnitude>>> {
    if (requestParameters.starId === null || requestParameters.starId === undefined) {
      throw new runtime.RequiredError(
        'starId',
        'Required parameter requestParameters.starId was null or undefined when calling getStarMagnitudes.'
      );
    }
    ...
    const response = await this.request(
      {
        path: `/stars/{starId}/magnitudes`.replace(
          `{${'starId'}}`,
          encodeURIComponent(String(requestParameters.starId))
        ),
        method: 'GET',
   ...
   * Get all magnitudes corresponding to specified star.
   */
  async getStarMagnitudes(
    requestParameters: GetStarMagnitudesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<Array<Magnitude>> {
   ...
   */
  async getStarMotionsRaw(
    requestParameters: GetStarMotionsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Array<Motion>>> {
    if (requestParameters.starId === null || requestParameters.starId === undefined) {
      throw new runtime.RequiredError(
        'starId',
        'Required parameter requestParameters.starId was null or undefined when calling getStarMotions.'
      );
    }
    ...
    const response = await this.request(
      {
        path: `/stars/{starId}/motions`.replace(
          `{${'starId'}}`,
          encodeURIComponent(String(requestParameters.starId))
        ),
        method: 'GET',
   ...
   * Get all motions corresponding to specified star.
   */
  async getStarMotions(
    requestParameters: GetStarMotionsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<Array<Motion>> {
   ...
   */
  async getStarRadialVelocitiesRaw(
    requestParameters: GetStarRadialVelocitiesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Array<RadialVelocity>>> {
    if (requestParameters.starId === null || requestParameters.starId === undefined) {
      throw new runtime.RequiredError(
        'starId',
        'Required parameter requestParameters.starId was null or undefined when calling getStarRadialVelocities.'
      );
    }
    ...
    const response = await this.request(
      {
        path: `/stars/{starId}/radialvelocities`.replace(
          `{${'starId'}}`,
          encodeURIComponent(String(requestParameters.starId))
        ),
        method: 'GET',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      jsonValue.map(RadialVelocityFromJSON)
    );
  }
   ...
   * Get all radial velocities corresponding to specified star.
   */
  async getStarRadialVelocities(
    requestParameters: GetStarRadialVelocitiesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<Array<RadialVelocity>> {
   ...
   */
  async getStarSpectraMeasurementsRaw(
    requestParameters: GetStarSpectraMeasurementsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Array<SpectrumMeasurement>>> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
      throw new runtime.RequiredError(
        'id',
        'Required parameter requestParameters.id was null or undefined when calling getStarSpectraMeasurements.'
      );
    }
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      jsonValue.map(SpectrumMeasurementFromJSON)
    );
  }
   ...
   * Get spectra measurements of star (specified by CP-Stars identifier) from corresponding file.
   */
  async getStarSpectraMeasurements(
    requestParameters: GetStarSpectraMeasurementsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<Array<SpectrumMeasurement>> {
   ...
   */
  async getStarSpectraMeasurementsByRensonRaw(
    requestParameters: GetStarSpectraMeasurementsByRensonRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Array<SpectrumMeasurement>>> {
    if (requestParameters.rensonId === null || requestParameters.rensonId === undefined) {
      throw new runtime.RequiredError(
        'rensonId',
        'Required parameter requestParameters.rensonId was null or undefined when calling getStarSpectraMeasurementsByRenson.'
      );
    }
    ...
    const response = await this.request(
      {
        path: `/stars/spectra/{rensonId}/renson`.replace(
          `{${'rensonId'}}`,
          encodeURIComponent(String(requestParameters.rensonId))
        ),
        method: 'GET',
   ...
   * Get spectra measurements of star (specified by Renson identifier) from corresponding file.
   */
  async getStarSpectraMeasurementsByRenson(
    requestParameters: GetStarSpectraMeasurementsByRensonRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<Array<SpectrumMeasurement>> {
    const response = await this.getStarSpectraMeasurementsByRensonRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
